...
@section('content')
    ...
    <main>
        ...
        <!-- Our Networks -->
        <section class="section-our-networks" id="our-networks">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h2>Our Networks</h2>
                    ...
                    <div class="col-md-2 text-center">
                        <img
                            src="frontend/images/logo_ana.png"
                            alt="ANA"
                            class="img-partner" />
                    </div>
                    <div class="col-md-2 text-center">
                        <img
                            src="frontend/images/logo_disney.png"
                            alt="ANA"
                            class="img-partner" />
                    </div>
                    <div class="col-md-2 text-center">
                        <img
                            src="frontend/images/logo_shangri-la.png"
                            alt="ANA"
                            class="img-partner" />
                    </div>
                    <div class="col-md-2 text-center">
                        <img
                            src="frontend/images/logo_visa.png"
                            alt="ANA"
                            class="img-partner" />
                    </div>
                </div>
